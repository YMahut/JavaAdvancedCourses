...
public class Main {
	...
	public static void main(String[] args) {
		...
		try{
			 ...
			 exchangeInfo(offset, avgTmp,"", url, username, password, "dailyrate", out);
			 
			 double tmp = avgTmp - offset;
			 out.println("</TABLE><H1> REPORTING :</h1> \n");
			 out.println("<H2> Average : "+average + "</H2>");
			 out.println("<H2> Offset : "+ offset +"</H2>");
			 out.println("<H2> Below : "+ offsetMoins + "</H2>");
			 out.println("<H2> Between : "+  offsetMiddle + "</H2>");
			 out.println("<H2> Above : "+ offsetPlus + "</H2>");
	...
	public void addToTable(double offset, double avg, String driver,
			String url,
			String username,
			String password,
			String tableName,
